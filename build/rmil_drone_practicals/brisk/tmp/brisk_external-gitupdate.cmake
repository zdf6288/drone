...
execute_process(
  COMMAND "/usr/bin/git" show-ref origin/main
  WORKING_DIRECTORY "/home/zhang/drone_workspace/build/rmil_drone_practicals/brisk/src/brisk_external"
...
if("${show_ref_output}" MATCHES "refs/remotes/origin/main")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "origin/main")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 origin/main
  WORKING_DIRECTORY "/home/zhang/drone_workspace/build/rmil_drone_practicals/brisk/src/brisk_external"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'git@github.com:smartroboticslab/brisk.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/zhang/drone_workspace/build/rmil_drone_practicals/brisk/src/brisk_external/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/zhang/drone_workspace/build/rmil_drone_practicals/brisk/src/brisk_external/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
