...
bool operator==(const ::ardrone_autonomy::navdata_euler_angles_<ContainerAllocator1> & lhs, const ::ardrone_autonomy::navdata_euler_angles_<ContainerAllocator2> & rhs)
{
