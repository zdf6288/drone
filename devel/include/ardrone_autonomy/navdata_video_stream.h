...
bool operator==(const ::ardrone_autonomy::navdata_video_stream_<ContainerAllocator1> & lhs, const ::ardrone_autonomy::navdata_video_stream_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.atcmd_ref_seq == rhs.atcmd_ref_seq &&
    lhs.atcmd_mean_ref_gap == rhs.atcmd_mean_ref_gap &&
    lhs.atcmd_var_ref_gap == rhs.atcmd_var_ref_gap &&
    lhs.atcmd_ref_quality == rhs.atcmd_ref_quality &&
    lhs.desired_bitrate == rhs.desired_bitrate &&
    lhs.data2 == rhs.data2 &&
    lhs.data3 == rhs.data3 &&
    lhs.data4 == rhs.data4 &&
    lhs.data5 == rhs.data5 &&
    lhs.fifo_queue_level == rhs.fifo_queue_level;
}
