...
bool operator==(const ::ardrone_autonomy::navdata_kalman_pressure_<ContainerAllocator1> & lhs, const ::ardrone_autonomy::navdata_kalman_pressure_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.drone_time == rhs.drone_time &&
    lhs.tag == rhs.tag &&
    lhs.size == rhs.size &&
    lhs.offset_pressure == rhs.offset_pressure &&
    lhs.est_z == rhs.est_z &&
    lhs.est_zdot == rhs.est_zdot &&
    lhs.est_bias_PWM == rhs.est_bias_PWM &&
    lhs.est_biais_pression == rhs.est_biais_pression &&
    lhs.offset_US == rhs.offset_US &&
    lhs.prediction_US == rhs.prediction_US &&
    lhs.cov_alt == rhs.cov_alt &&
    lhs.cov_PWM == rhs.cov_PWM &&
    lhs.cov_vitesse == rhs.cov_vitesse &&
    lhs.bool_effet_sol == rhs.bool_effet_sol &&
    lhs.somme_inno == rhs.somme_inno &&
    lhs.flag_rejet_US == rhs.flag_rejet_US &&
    lhs.u_multisinus == rhs.u_multisinus &&
    lhs.gaz_altitude == rhs.gaz_altitude &&
    lhs.Flag_multisinus == rhs.Flag_multisinus &&
    lhs.Flag_multisinus_debut == rhs.Flag_multisinus_debut;
}
