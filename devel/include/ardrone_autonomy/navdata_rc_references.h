...
bool operator==(const ::ardrone_autonomy::navdata_rc_references_<ContainerAllocator1> & lhs, const ::ardrone_autonomy::navdata_rc_references_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.drone_time == rhs.drone_time &&
    lhs.tag == rhs.tag &&
    lhs.size == rhs.size &&
    lhs.rc_ref_pitch == rhs.rc_ref_pitch &&
    lhs.rc_ref_roll == rhs.rc_ref_roll &&
    lhs.rc_ref_yaw == rhs.rc_ref_yaw &&
    lhs.rc_ref_gaz == rhs.rc_ref_gaz &&
    lhs.rc_ref_ag == rhs.rc_ref_ag;
}
