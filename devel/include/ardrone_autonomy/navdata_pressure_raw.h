...
bool operator==(const ::ardrone_autonomy::navdata_pressure_raw_<ContainerAllocator1> & lhs, const ::ardrone_autonomy::navdata_pressure_raw_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.up == rhs.up &&
    lhs.ut == rhs.ut &&
    lhs.Temperature_meas == rhs.Temperature_meas &&
    lhs.Pression_meas == rhs.Pression_meas;
}
