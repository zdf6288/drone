...
struct navdata_vision_of_
{
  ...
  _size_type size;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _of_dx_type;
  _of_dx_type of_dx;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _of_dy_type;
  _of_dy_type of_dy;
...
bool operator==(const ::ardrone_autonomy::navdata_vision_of_<ContainerAllocator1> & lhs, const ::ardrone_autonomy::navdata_vision_of_<ContainerAllocator2> & rhs)
{
