...
bool operator==(const ::ardrone_autonomy::navdata_hdvideo_stream_<ContainerAllocator1> & lhs, const ::ardrone_autonomy::navdata_hdvideo_stream_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.drone_time == rhs.drone_time &&
    lhs.tag == rhs.tag &&
    lhs.size == rhs.size &&
    lhs.hdvideo_state == rhs.hdvideo_state &&
    lhs.storage_fifo_nb_packets == rhs.storage_fifo_nb_packets &&
    lhs.storage_fifo_size == rhs.storage_fifo_size &&
    lhs.usbkey_size == rhs.usbkey_size &&
    lhs.usbkey_freespace == rhs.usbkey_freespace &&
    lhs.frame_number == rhs.frame_number &&
    lhs.usbkey_remaining_time == rhs.usbkey_remaining_time;
}
