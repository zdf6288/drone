...
bool operator==(const ::ardrone_autonomy::navdata_trims_<ContainerAllocator1> & lhs, const ::ardrone_autonomy::navdata_trims_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.drone_time == rhs.drone_time &&
    lhs.tag == rhs.tag &&
    lhs.size == rhs.size &&
    lhs.angular_rates_trim_r == rhs.angular_rates_trim_r &&
    lhs.euler_angles_trim_theta == rhs.euler_angles_trim_theta &&
    lhs.euler_angles_trim_phi == rhs.euler_angles_trim_phi;
}
