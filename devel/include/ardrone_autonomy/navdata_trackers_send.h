...
struct navdata_trackers_send_
{
  ...
  _size_type size;
   ...
   typedef std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> _locked_type;
  _locked_type locked;

   typedef std::vector< ::ardrone_autonomy::vector21_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::ardrone_autonomy::vector21_<ContainerAllocator> >> _point_type;
  _point_type point;
...
bool operator==(const ::ardrone_autonomy::navdata_trackers_send_<ContainerAllocator1> & lhs, const ::ardrone_autonomy::navdata_trackers_send_<ContainerAllocator2> & rhs)
{
