...
struct navdata_vision_detect_
{
  ...
  _nb_detected_type nb_detected;
   ...
   typedef std::vector<uint32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint32_t>> _type_type;
  _type_type type;

   typedef std::vector<uint32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint32_t>> _xc_type;
  _xc_type xc;

   typedef std::vector<uint32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint32_t>> _yc_type;
  _yc_type yc;

   typedef std::vector<uint32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint32_t>> _width_type;
  _width_type width;

   typedef std::vector<uint32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint32_t>> _height_type;
  _height_type height;

   typedef std::vector<uint32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint32_t>> _dist_type;
  _dist_type dist;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _orientation_angle_type;
  _orientation_angle_type orientation_angle;

   typedef std::vector< ::ardrone_autonomy::matrix33_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::ardrone_autonomy::matrix33_<ContainerAllocator> >> _rotation_type;
  _rotation_type rotation;

   typedef std::vector< ::ardrone_autonomy::vector31_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::ardrone_autonomy::vector31_<ContainerAllocator> >> _translation_type;
  _translation_type translation;

   typedef std::vector<uint32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint32_t>> _camera_source_type;
...
bool operator==(const ::ardrone_autonomy::navdata_vision_detect_<ContainerAllocator1> & lhs, const ::ardrone_autonomy::navdata_vision_detect_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.drone_time == rhs.drone_time &&
    lhs.tag == rhs.tag &&
    lhs.size == rhs.size &&
    lhs.nb_detected == rhs.nb_detected &&
    lhs.type == rhs.type &&
    lhs.xc == rhs.xc &&
    lhs.yc == rhs.yc &&
    lhs.width == rhs.width &&
