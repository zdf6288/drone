...
struct Navdata_
{
  ...
  _tags_count_type tags_count;
   ...
   typedef std::vector<uint32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint32_t>> _tags_type_type;
  _tags_type_type tags_type;

   typedef std::vector<uint32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint32_t>> _tags_xc_type;
  _tags_xc_type tags_xc;

   typedef std::vector<uint32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint32_t>> _tags_yc_type;
  _tags_yc_type tags_yc;

   typedef std::vector<uint32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint32_t>> _tags_width_type;
  _tags_width_type tags_width;

   typedef std::vector<uint32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint32_t>> _tags_height_type;
  _tags_height_type tags_height;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _tags_orientation_type;
  _tags_orientation_type tags_orientation;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _tags_distance_type;
...
bool operator==(const ::ardrone_autonomy::Navdata_<ContainerAllocator1> & lhs, const ::ardrone_autonomy::Navdata_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.wind_angle == rhs.wind_angle &&
    lhs.wind_comp_angle == rhs.wind_comp_angle &&
    lhs.rotX == rhs.rotX &&
    lhs.rotY == rhs.rotY &&
    lhs.rotZ == rhs.rotZ &&
    lhs.altd == rhs.altd &&
    ...
    lhs.tags_count == rhs.tags_count &&
    lhs.tags_type == rhs.tags_type &&
    lhs.tags_xc == rhs.tags_xc &&
    lhs.tags_yc == rhs.tags_yc &&
    lhs.tags_width == rhs.tags_width &&
    lhs.tags_height == rhs.tags_height &&
    lhs.tags_orientation == rhs.tags_orientation &&
    lhs.tags_distance == rhs.tags_distance &&
    lhs.tm == rhs.tm;
}
