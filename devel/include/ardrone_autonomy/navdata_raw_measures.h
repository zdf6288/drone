...
struct navdata_raw_measures_
{
  ...
  _size_type size;
   ...
   typedef std::vector<int16_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int16_t>> _raw_gyros_type;
  _raw_gyros_type raw_gyros;

   typedef std::vector<int16_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int16_t>> _raw_gyros_110_type;
...
bool operator==(const ::ardrone_autonomy::navdata_raw_measures_<ContainerAllocator1> & lhs, const ::ardrone_autonomy::navdata_raw_measures_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.drone_time == rhs.drone_time &&
    lhs.tag == rhs.tag &&
    lhs.size == rhs.size &&
    lhs.raw_gyros == rhs.raw_gyros &&
    lhs.raw_gyros_110 == rhs.raw_gyros_110 &&
    lhs.vbat_raw == rhs.vbat_raw &&
    lhs.us_debut_echo == rhs.us_debut_echo &&
    lhs.us_fin_echo == rhs.us_fin_echo &&
    lhs.us_association_echo == rhs.us_association_echo &&
    lhs.us_distance_echo == rhs.us_distance_echo &&
    lhs.us_courbe_temps == rhs.us_courbe_temps &&
    lhs.us_courbe_valeur == rhs.us_courbe_valeur &&
    lhs.us_courbe_ref == rhs.us_courbe_ref &&
    lhs.flag_echo_ini == rhs.flag_echo_ini &&
    lhs.nb_echo == rhs.nb_echo &&
    lhs.sum_echo == rhs.sum_echo &&
    lhs.alt_temp_raw == rhs.alt_temp_raw &&
