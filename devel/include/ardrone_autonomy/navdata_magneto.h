...
bool operator==(const ::ardrone_autonomy::navdata_magneto_<ContainerAllocator1> & lhs, const ::ardrone_autonomy::navdata_magneto_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.my == rhs.my &&
    lhs.mz == rhs.mz &&
    lhs.magneto_raw == rhs.magneto_raw &&
    lhs.magneto_rectified == rhs.magneto_rectified &&
    lhs.magneto_offset == rhs.magneto_offset &&
    lhs.heading_unwrapped == rhs.heading_unwrapped &&
    lhs.heading_gyro_unwrapped == rhs.heading_gyro_unwrapped &&
    lhs.heading_fusion_unwrapped == rhs.heading_fusion_unwrapped &&
    lhs.magneto_calibration_ok == rhs.magneto_calibration_ok &&
    lhs.magneto_state == rhs.magneto_state &&
    lhs.magneto_radius == rhs.magneto_radius &&
    lhs.error_mean == rhs.error_mean &&
    lhs.error_var == rhs.error_var;
}
