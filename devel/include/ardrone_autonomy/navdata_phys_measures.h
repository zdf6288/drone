...
struct navdata_phys_measures_
{
  ...
  _gyro_temp_type gyro_temp;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _phys_accs_type;
  _phys_accs_type phys_accs;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _phys_gyros_type;
...
bool operator==(const ::ardrone_autonomy::navdata_phys_measures_<ContainerAllocator1> & lhs, const ::ardrone_autonomy::navdata_phys_measures_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.drone_time == rhs.drone_time &&
    lhs.tag == rhs.tag &&
    lhs.size == rhs.size &&
    lhs.accs_temp == rhs.accs_temp &&
    lhs.gyro_temp == rhs.gyro_temp &&
    lhs.phys_accs == rhs.phys_accs &&
    lhs.phys_gyros == rhs.phys_gyros &&
    lhs.alim3V3 == rhs.alim3V3 &&
    lhs.vrefEpson == rhs.vrefEpson &&
    lhs.vrefIDG == rhs.vrefIDG;
}
