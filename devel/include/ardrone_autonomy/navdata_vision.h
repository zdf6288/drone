...
bool operator==(const ::ardrone_autonomy::navdata_vision_<ContainerAllocator1> & lhs, const ::ardrone_autonomy::navdata_vision_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.drone_time == rhs.drone_time &&
    lhs.tag == rhs.tag &&
    lhs.size == rhs.size &&
    lhs.vision_state == rhs.vision_state &&
    lhs.vision_misc == rhs.vision_misc &&
    lhs.vision_phi_trim == rhs.vision_phi_trim &&
    lhs.vision_phi_ref_prop == rhs.vision_phi_ref_prop &&
    lhs.vision_theta_trim == rhs.vision_theta_trim &&
    lhs.vision_theta_ref_prop == rhs.vision_theta_ref_prop &&
    lhs.new_raw_picture == rhs.new_raw_picture &&
    lhs.theta_capture == rhs.theta_capture &&
    lhs.phi_capture == rhs.phi_capture &&
    lhs.psi_capture == rhs.psi_capture &&
    lhs.altitude_capture == rhs.altitude_capture &&
    lhs.time_capture == rhs.time_capture &&
    lhs.body_v == rhs.body_v &&
    lhs.delta_phi == rhs.delta_phi &&
    lhs.delta_theta == rhs.delta_theta &&
    lhs.delta_psi == rhs.delta_psi &&
    lhs.gold_defined == rhs.gold_defined &&
    lhs.gold_reset == rhs.gold_reset &&
    lhs.gold_x == rhs.gold_x &&
    lhs.gold_y == rhs.gold_y;
}
