...
bool operator==(const ::ardrone_autonomy::navdata_demo_<ContainerAllocator1> & lhs, const ::ardrone_autonomy::navdata_demo_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.drone_time == rhs.drone_time &&
    lhs.tag == rhs.tag &&
    lhs.size == rhs.size &&
    lhs.ctrl_state == rhs.ctrl_state &&
    lhs.vbat_flying_percentage == rhs.vbat_flying_percentage &&
    lhs.theta == rhs.theta &&
    lhs.phi == rhs.phi &&
    lhs.psi == rhs.psi &&
    ...
    lhs.detection_camera_type == rhs.detection_camera_type;
}
