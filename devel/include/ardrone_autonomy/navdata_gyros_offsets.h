...
struct navdata_gyros_offsets_
{
  ...
  _size_type size;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _offset_g_type;
...
bool operator==(const ::ardrone_autonomy::navdata_gyros_offsets_<ContainerAllocator1> & lhs, const ::ardrone_autonomy::navdata_gyros_offsets_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.drone_time == rhs.drone_time &&
    lhs.tag == rhs.tag &&
    lhs.size == rhs.size &&
    lhs.offset_g == rhs.offset_g;
}
