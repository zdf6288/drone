...
bool operator==(const ::ardrone_autonomy::navdata_references_<ContainerAllocator1> & lhs, const ::ardrone_autonomy::navdata_references_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.drone_time == rhs.drone_time &&
    lhs.tag == rhs.tag &&
    lhs.size == rhs.size &&
    lhs.ref_theta == rhs.ref_theta &&
    lhs.ref_phi == rhs.ref_phi &&
    lhs.ref_theta_I == rhs.ref_theta_I &&
    lhs.ref_phi_I == rhs.ref_phi_I &&
    lhs.ref_pitch == rhs.ref_pitch &&
    lhs.ref_roll == rhs.ref_roll &&
    lhs.ref_yaw == rhs.ref_yaw &&
    lhs.ref_psi == rhs.ref_psi &&
    lhs.vx_ref == rhs.vx_ref &&
    lhs.vy_ref == rhs.vy_ref &&
    lhs.theta_mod == rhs.theta_mod &&
    lhs.phi_mod == rhs.phi_mod &&
    lhs.k_v_x == rhs.k_v_x &&
    lhs.k_v_y == rhs.k_v_y &&
    lhs.k_mode == rhs.k_mode &&
    lhs.ui_time == rhs.ui_time &&
    lhs.ui_theta == rhs.ui_theta &&
    lhs.ui_phi == rhs.ui_phi &&
    lhs.ui_psi == rhs.ui_psi &&
    lhs.ui_psi_accuracy == rhs.ui_psi_accuracy &&
    lhs.ui_seq == rhs.ui_seq;
}
