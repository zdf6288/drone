...
bool operator==(const ::ardrone_autonomy::navdata_altitude_<ContainerAllocator1> & lhs, const ::ardrone_autonomy::navdata_altitude_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.drone_time == rhs.drone_time &&
    lhs.tag == rhs.tag &&
    lhs.size == rhs.size &&
    lhs.altitude_vision == rhs.altitude_vision &&
    lhs.altitude_vz == rhs.altitude_vz &&
    lhs.altitude_ref == rhs.altitude_ref &&
    lhs.altitude_raw == rhs.altitude_raw &&
    lhs.obs_accZ == rhs.obs_accZ &&
    lhs.obs_alt == rhs.obs_alt &&
    lhs.obs_x == rhs.obs_x &&
    lhs.obs_state == rhs.obs_state &&
    lhs.est_vb == rhs.est_vb &&
    lhs.est_state == rhs.est_state;
}
