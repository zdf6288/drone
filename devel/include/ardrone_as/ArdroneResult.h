...
struct ArdroneResult_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::sensor_msgs::CompressedImage_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::sensor_msgs::CompressedImage_<ContainerAllocator> >> _allPictures_type;
